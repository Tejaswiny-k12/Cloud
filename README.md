# A Cloud-Based Framework for Anomaly Detection in Medical IoT Devices
...
- 📊 Live alert dashboard (Streamlit-based)  
...
- Hospital security teams monitoring device behavior  
- Smart clinic IoT deployments needing anomaly alerts  
- Research in healthcare IoT cybersecurity
